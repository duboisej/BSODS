...
typedef enum  {
  ...
  PROTO_MT_EVENT_BASE_MOVE,
  PROTO_MT_EVENT_BASE_PICKUPFLAG,
  PROTO_MT_EVENT_BASE_DROPFLAG,
  PROTO_MT_EVENT_BASE_BREAKWALL,
  PROTO_MT_EVENT_BASE_PICKUPHAMMER,
  PROTO_MT_EVENT_BASE_DROPHAMMER,
